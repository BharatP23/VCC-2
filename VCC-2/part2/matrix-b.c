...
void set_timer()
{
    //In this the structure sigaction is used to set flags and the handler function and whenever the particular signal is occurred you need to perfom this actions
    struct sigaction sa;
    ...
    //This structure is used for handling the signal that it should notify when the timer expire and which signal to be send
    struct sigevent   sev;
