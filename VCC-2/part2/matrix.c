...
/*The code in the function set_timer() is taken from the Reference provided by sir*/
/*The Reference link is :: https://man7.org/linux/man-pages/man2/timer_create.2.html*/
void set_timer()
{
...
void kvm_run_vm(struct vm *vm1, struct vm *vm2)
{
    ...
    set_timer();
    /*This below code before the while loop is taken from the references and the link is pasted below*/
    /*The link for the references is :::https://elixir.bootlin.com/linux/v6.1/source/tools/testing/selftests/kvm/dirty_log_test.c#L526*/
    ...
    while(1)
    {
        ...
        //This code is too handle the vm switch 
        if (vm == vm1 && (quantum_counter % FRAC_A) == 0) {
            vm = vm2; 
            quantum_counter=0;
        } else if (vm == vm2 && (quantum_counter % FRAC_B) == 0) {
            vm = vm1; 
            quantum_counter=0;
        }
   }
